 ...
 * @author SAGOR
 */
public class Subject_EntryController implements Initializable {

    /**
     * Initializes the controller class.
     */
    
    @FXML private TextField Sub_nme;
    @FXML private TextField Sub_cd;
    ...
    void submitButtonAction(ActionEvent event){
        String nm, cd;
        nm = Sub_nme.getText(); cd = Sub_cd.getText();
