 ...
 * @author SAGOR
 */
public class ShowEmployees_OffController implements Initializable {
    ...
    public void load()
    {
        ...
        {
            data.add(new Employee_Off(row.get(0), row.get(1), row.get(2), row.get(3), row.get(4), row.get(5), row.get(6), row.get(7)));
        }
