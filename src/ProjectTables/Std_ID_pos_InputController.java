 ...
 * @author SAGOR
 */
public class Std_ID_pos_InputController implements Initializable {
    ...
    public void SubmitbtnAction(ActionEvent event)
    {
        try{
            ...
            FXMLLoader Loader = new FXMLLoader(getClass().getResource("Showpos_Std.fxml"));/* Exception */
            Parent root = (Parent)Loader.load();
            
            Showpos_StdController sfs = Loader.getController();
            sfs.Showpos(exmtxtfld.getText(),stdtxtfld.getText());
            Scene scene = new Scene(root);
            stage.setScene(scene);
            stage.setTitle("Student's Position");
            stage.show();
